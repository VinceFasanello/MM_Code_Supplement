...
# Date: July 5 2019
# ProjectID: 250-generation experiment, Library 002
...
dir_metadata <- "1_FastQtoCounts/002/002_Metadata"
dir_it_fastq <- "1_FastQtoCounts/002/002_IonTorrent_Files/002_IonTorrent_FastQ"
dir_it_df <- "1_FastQtoCounts/002/002_IonTorrent_Files/002_IonTorrent_DF"
dir_counts <-"1_FastQtoCounts/002/002_Counts"
# ------------------------------------------------------------------------------
...
layout <- read.csv(file = "002_layout.csv", header = TRUE, stringsAsFactors = FALSE)

# Loud mobyBCs csv and store as an object
mobyBCs <- read.csv(file = "002_mobyBCs.csv", header = TRUE, stringsAsFactors = FALSE)
...
primers <- read.csv(file = "002_primers.csv", header = TRUE, stringsAsFactors = FALSE)
# ------------------------------------------------------------------------------
...
fastq.filenames <- fastq.filenames[1:24]	# truncate the fastq.filenames object to omit the nomatch file
fastq.a.primers <- fastq.a.primers[1:24]	# (Forward primers) truncate the fastq.a.primers object to omit the "none" entry

p1.primer.ids <- primers$primer.id[25:46]		# Store the names of the reverse primers in an object
p1.primer.bcs <- primers$primer.barcode.r[25:46]	# stores the sequence of the reverse primers in an object
