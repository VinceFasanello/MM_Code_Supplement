...
# Date: July 5 2019
# ProjectID: 250-generation experiment, Library 002 Reruns
...
dir_metadata <- "1_FastQtoCounts/002_Reruns/002_Reruns_Metadata"
dir_it_fastq <- "1_FastQtoCounts/002_Reruns/002_Reruns_IonTorrent_Files/002_Reruns_IonTorrent_FastQ"
dir_it_df <- "1_FastQtoCounts/002_Reruns/002_Reruns_IonTorrent_Files/002_Reruns_IonTorrent_DF"
dir_counts <-"1_FastQtoCounts/002_Reruns/002_Reruns_Counts"
# ------------------------------------------------------------------------------
...
layout <- read.csv(file = "002_Reruns_layout.csv", header = TRUE, stringsAsFactors = FALSE)
layout[, ncol(layout)] <- ""

# Loud mobyBCs csv and store as an object
mobyBCs <- read.csv(file = "002_Reruns_mobyBCs.csv", header = TRUE, stringsAsFactors = FALSE)
...
primers <- read.csv(file = "002_Reruns_primers.csv", header = TRUE, stringsAsFactors = FALSE)
# ------------------------------------------------------------------------------
...
for (i in 1:length(fastq.filenames)) {
	fastq.a.primers[i] <- paste("Ion_",substr(fastq.filenames[i], 2, 3), sep = "")
}
rm(i)
